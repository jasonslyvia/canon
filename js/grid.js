...
gbks.Grid = function () {
    this.init = function (e) {
        ...
        this.polaroid.init();
        $("#homeNav").show();
        $(".hometile .nav a").click($.proxy(this.onClickHomeNavItem, this));
        $(".hometile .categories a").click($.proxy(this.onClickHomeNavItem, this));
        $(".followButton").click($.proxy(this.onClickFollowButton, this))
    };
    this.onClickHomeNavItem = function (e) {
        ...
        if (n && n.length > 0) {
            ...
            this.layout.itemCount = null;
            $("#images .polaroid").remove();
            this.layout.loadMore();
            $(".hometile .nav li").removeClass("active");
            $(".hometile .categories li").removeClass("active");
    ...
    this.onClickFollowButton = function (e) {
        ...
        var t = $(e.currentTarget),
            ...
            o = r.hasClass("active");
        if (s && i) {
            var u = "/following/follow",
                a = "Following";
            if (o) {
                u = "/following/unfollow";
                a = "Follow";
